...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenDimensions; viewport?: ViewportDimensions } = {}) {
...
class App {
  ...
  constructor(container: HTMLElement, { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px Figtree" }: AppProps = {}) {
  ...
  createMedias(items: MediaItem[] | undefined, bend: number = 1, textColor: string | undefined, borderRadius: number | undefined, font: string | undefined) {
  ...
  onTouchMove(e: MouseEvent | TouchEvent) {
    ...
    const distance = (this.start - x) * 0.0125
  ...
  onWheel(e: WheelEvent) {
    this.scroll.target += e.deltaY * 0.125; // Adjust sensitivity as needed
